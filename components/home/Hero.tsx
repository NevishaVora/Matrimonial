...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative overflow-hidden bg-gradient-to-b from-[#FFFDF8] via-white to-white pt-28 md:pt-32 lg:pt-36 pb-14 md:pb-16 lg:pb-20"
    >
      {/* Background Blur */}
      <div className="absolute left-0 top-0 h-56 w-56 md:h-72 md:w-72 lg:h-96 lg:w-96 rounded-full bg-[#C7A54B]/10 blur-3xl" />
      ...
      <Container>
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            <span className="inline-flex rounded-full bg-[#FFF6DD] px-4 py-2 text-xs font-semibold text-[#C7A54B] sm:px-5 sm:text-sm">
              ❤️ Trusted Matrimonial Platform
            </span>

            <h1 className="mt-5 text-4xl font-bold leading-tight text-gray-900 sm:text-5xl lg:text-6xl">
              Find Your
              <span className="block text-[#C7A54B]">
